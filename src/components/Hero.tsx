    ...
    <section id="hero" className="hero">
      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <div className="hero-typing" data-reveal="fade-up">
            <span>{text}</span>
          ...
          <div className="hero-actions" data-reveal="fade-up">
            <button className="btn btn-primary" onClick={() => scrollTo('demo')}>
              <i className="fas fa-play"></i> See the Demo
            </button>
            <button className="btn btn-outline" onClick={() => scrollTo('contact')}>
              <i className="fas fa-envelope"></i> Contact Me
            </button>
            <a href="https://github.com/unmasked2105" target="_blank" rel="noopener" className="btn btn-icon" aria-label="GitHub">
              <i className="fab fa-github"></i>
            </a>
            <a href="https://leetcode.com/u/deeps2004/" target="_blank" rel="noopener" className="btn btn-icon" aria-label="LeetCode">
              <i className="fas fa-code"></i>
            </a>
            <a href="https://linkedin.com/in/deep-shah-183890256" target="_blank" rel="noopener" className="btn btn-icon" aria-label="LinkedIn">
