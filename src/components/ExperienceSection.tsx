      ...
      <div className="container">
        ...
        <div className="exp-timeline">
          {EXP.map((e, i) => (
            <div key={i} className="exp-item" data-reveal="fade-up">
              <div className={`exp-dot ${e.current ? 'current-dot' : ''}`} />
              <div className="exp-card">
                {e.current && <span className="exp-badge current">Current</span>}
                <h3 className="exp-role">{e.role}</h3>
                <div className="exp-company">
                  <i className="fas fa-building"></i> {e.company}
                  {e.location && <span className="exp-loc"><i className="fas fa-map-marker-alt"></i> {e.location}</span>}
                </div>
                <span className="exp-date"><i className="far fa-calendar-alt"></i> {e.date}</span>
        ...
        <div className="edu-cert-section" data-reveal="fade-up">
          <div className="edu-row">
            <a href="https://drive.google.com/file/d/17QDD-WbACf4NaDlE_1ZsN0IZH5kxr_kj/view" target="_blank" rel="noopener" className="edu-card-single">
              <div className="edu-icon"><i className="fas fa-graduation-cap"></i></div>
              <div>
                <h4>B.Tech Computer Engineering <i className="fas fa-external-link-alt" style={{ fontSize: '0.65rem', color: 'var(--a1)', opacity: 0.6 }}></i></h4>
          ...
          <div className="cert-row">
            <h4 className="cert-heading"><i className="fas fa-certificate"></i> Certifications</h4>
            <div className="cert-list">
              <a href="https://drive.google.com/file/d/1n5AEcn0ipVKhQjNyOwwQr5T3se4eOR3Y/view" target="_blank" rel="noopener"><i className="fas fa-check-circle"></i> Programming Diploma – IIT Madras</a>
              <a href="https://drive.google.com/file/d/1njTQXxonOXXYDEDSFBMbuc89_aAoXnZp/view" target="_blank" rel="noopener"><i className="fas fa-check-circle"></i> Deep Learning using PyTorch – IIT Madras</a>
              <a href="https://drive.google.com/file/d/1viQcqvMd-gaYkI3wakXCpzpbM9tlNzUY/view" target="_blank" rel="noopener"><i className="fas fa-check-circle"></i> Understanding GCP – IIT Madras</a>
              <a href="https://drive.google.com/file/d/1Le8yv-fhBKwF_dt0RglH6XdTwTgDCAJn/view" target="_blank" rel="noopener"><i className="fas fa-check-circle"></i> Dynamic Programming – IIT Madras</a>
            </div>
          </div>
        </div>
      </div>
